    ...
    >
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col justify-between px-6 pb-12 pt-28 md:px-10 md:pb-16 md:pt-32">
        ...
        <div className="max-w-[1600px]">
          <h1 ref={headlineRef} className="font-display text-display-xl text-[var(--color-fg)]" style={{ opacity: 0 }}>
            {t('hero.headline')}
          </h1>
          <p ref={subRef} className="lead mt-8 max-w-2xl text-[var(--color-fg)]/85" style={{ opacity: 0 }}>
            {t('hero.sub')}
          </p>
        </div>
