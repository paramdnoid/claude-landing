...
4. `build` for Next.js or production-impacting changes if available.
5. Manual review of Server/Client Component boundaries.
...
- **High**: broken UX, hydration error, major accessibility block, incorrect localization, unbounded resource leak.
