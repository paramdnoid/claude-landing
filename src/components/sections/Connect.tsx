                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 pt-1">
                        ...
                        <button
                          ...
                          onClick={cancelForm}
                          disabled={formStatus === 'pending'}
                          className="font-mono text-[10px] uppercase tracking-[0.18em] text-muted transition-colors hover:text-fg disabled:cursor-not-allowed disabled:opacity-30"
                        >
                ...
                <div className="flex items-center gap-3">
                  ...
                  {chatStatus === 'streaming' ? (
                    ...
                    <button
                      ...
                      className="font-mono text-xs uppercase tracking-[0.15em] text-muted transition-colors hover:text-fg disabled:cursor-not-allowed disabled:opacity-30"
                    >
