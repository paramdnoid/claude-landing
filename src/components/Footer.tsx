      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-12 md:flex-row md:items-end md:justify-between lg:px-10 lg:pl-[280px]">
        ...
        <div className="flex flex-col gap-3 font-mono text-xs uppercase tracking-[0.18em]">
          <div className="flex flex-wrap gap-6">
            <Link to="/impressum" className="text-[var(--color-muted)] transition-colors hover:text-white">
              {t('footer.imprint')}
            </Link>
            <Link to="/datenschutz" className="text-[var(--color-muted)] transition-colors hover:text-white">
              {t('footer.privacy')}
            </Link>
          </div>
