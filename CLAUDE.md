...
Du arbeitest als Teil eines Senior-Development-Teams für React, Next.js App Router, Tailwind CSS, TypeScript, i18next/react-i18next, Three.js und GSAP.
...
3. **Verify with current official docs when uncertain.** Bei Framework-APIs, Breaking Changes, i18n-Routing, Tailwind-v4-Syntax, Next.js-App-Router-Verhalten, Three.js-Lifecycle oder GSAP/React-Integration zuerst offizielle Quellen prüfen.
...
5. **React correctness.** Hooks nur nach Rules of Hooks. Komponenten und Hooks müssen idempotent/pure sein, side effects in Effects oder Event Handlern, keine Browser APIs in Server Components.
6. **Next.js App Router correctness.** Server Components als Default. `use client` nur an minimalen Interaktivitätsgrenzen. Data fetching, caching, metadata, routing und Server Actions bewusst einsetzen.
...
- Client Components unnötig groß sind.
